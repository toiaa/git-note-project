  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        table: "w-full border-collapse space-y-1 bg-dark-700 dark:bg-slate-950",
        head_row: "flex",
        head_cell:
        ...
        day_selected: " bg-slate-100 dark:bg-slate-800 text-dark-900",
        day_today:
          "border border-light-300 text-light-300 dark:bg-slate-800 dark:text-slate-50",
        day_outside:
